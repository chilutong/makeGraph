...
dataset = 'D.melanogaster(2009)'
root_path = "./mean_std_plot_8/"+ dataset +"/"
...
plt.xticks(range(8),['Accuracy','Precision','Recall','Specificity','F1-score','MCC','AUROC','AP'],fontsize=9)
plt.yticks(np.arange(0, 1.01, 0.2), fontsize=11)
plt.title(dataset,fontsize=11)
plt.savefig('./bar3/'+dataset+'.tif',bbox_inches='tight')
plt.savefig('./bar3/'+dataset+'.png',bbox_inches='tight')
